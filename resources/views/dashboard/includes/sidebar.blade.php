        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.main_categories.creat')}}" data-i18n="nav.dash.crypto">أضافة
                             قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.brands.creat')}}" data-i18n="nav.dash.crypto">أضافة
                            ماركه  </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">العلامات ال Tags  </span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.tags.creat')}}" data-i18n="nav.dash.crypto">أضافة
                            Tags </a>
                    </li>
                </ul>
            </li>
