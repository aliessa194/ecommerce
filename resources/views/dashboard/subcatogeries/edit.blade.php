                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.sub_categories.update',$mainCategory -> id)}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">اختر قسم رئيسي</label>
                                                            <select id="abbr"
                                                                    class="form-control"
                                                                    placeholder="  "
                                                                    name="parent_id">

                                                                <optgroup label="اختر قسم رئيسي">
                                                                    @if($cat&& $cat->count() > 0)
                                                                        @foreach($cat as $catt)
                                                                            <option value="{{$catt->id}}" @if($catt -> id == $mainCategory -> parent_id) selected @endif > {{ $catt->name }}</option>
                                                                        @endforeach
                                                                    @endif
